/*
Template Name: Beautiful Minds International School
Author: Ingrid Kuhn
            ...
            if (startchange.length) {
                $(document).scroll(function () {
                    ...
                    if (scroll_start > offset.top) {
						$(".nav-brand img").css('height', '60px');
						$(".nav-brand img").css('padding', '4px 0 0 0');
						$(".navbar").css('height', '66px');   
						$(".navbar-waves").css('top', '64px'); 
						$("#nav-btn .nav-link").css('margin-top', '10px');  
						$(".navbar-nav .nav-link:not(.btn-quaternary)").css('line-height', '50px');
                    } else {
						$(".nav-brand img").css('height', '86px');
						$(".navbar").css('height', '86px'); 
						$(".navbar-waves").css('top', '83px');
						$("#nav-btn .nav-link").css('margin-top', '20px'); 
						$(".navbar-nav .nav-link:not(.btn-quaternary)").css('line-height', '70px');
                    }
                });
            }
        })
